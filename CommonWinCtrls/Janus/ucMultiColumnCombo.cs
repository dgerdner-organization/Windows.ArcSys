...
{
	/// <summary>AAL version of the Janus MultiColumnCombo</summary>
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	[ToolboxBitmap(typeof(MultiColumnCombo))]
	public partial class ucMultiColumnCombo : MultiColumnCombo, IComboBox
	{
		#region Fields
		...
		/// <summary>Gets/Sets the base.DataSource property. The recommended
		/// practice is to use the Table property to set the data source unless
		/// the data source is not a DataTable or DataView. This is needed so we
		/// can update the Table property if the data source is set through this
		/// property.</summary>
		[Browsable(false)]
