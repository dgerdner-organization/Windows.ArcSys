...
namespace CS2010.CommonWinCtrls
{
	...
	public partial class ucDateGroupBox : UserControl
	{
		#region Fields

		/// <summary>Data storage for the ValueRange property</summary>
		protected DateRange _ValueRange;
		protected string _DateFormatEdit;
		protected string _DateFormatDefault;
		...
		public string DateFormatDefault
		{
			get { return _DateFormatDefault; }
			set
			{
				if (_DateFormatDefault == value && dteFrom.DefaultFormat == value &&
					dteTo.DefaultFormat == value) return;

				_DateFormatDefault = value;
				dteFrom.DefaultFormat = _DateFormatDefault;
				dteTo.DefaultFormat = _DateFormatDefault;
			}
		}

		/// <summary>Gets/Sets the edit format of the date boxes</summary>
		[DefaultValue(Dates.DateFormatEdit)]
		[Description("Gets/Sets the edit format of the date boxes")]
		public string DateFormatEdit
		{
			get { return _DateFormatEdit; }
			set
			{
				if (_DateFormatEdit == value && dteFrom.EditFormat == value &&
					dteTo.EditFormat == value) return;

				_DateFormatEdit = value;
				dteFrom.EditFormat = _DateFormatEdit;
				dteTo.EditFormat = _DateFormatEdit;
			}
		}
		...
		public ucDateGroupBox()
		{
			...
			_DateFormatDefault = Dates.DateFormatDefault;
			_DateFormatEdit = Dates.DateFormatEdit;
		...
		protected override void OnBackColorChanged(EventArgs e)
		{
			...
			dteFrom.LabelBackColor = BackColor;
			dteTo.LabelBackColor = BackColor;
		}
