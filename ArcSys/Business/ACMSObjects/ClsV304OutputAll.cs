...
{
	public partial class ClsV304OutputAll : ClsBaseTable
	{
		...
		public const string TableName = "V_304_OUTPUT_ALL";
		...
		public const string SelectSQL = "SELECT * FROM V_304_OUTPUT_ALL";
		...
		public ClsV304OutputAll() : base() {}
		public ClsV304OutputAll(DataRow dr) : base(dr) {}
		public ClsV304OutputAll(ClsV304OutputAll src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsV304OutputAll src)
		{
		...
		{
			ClsV304OutputAll tmp = null;	//No primary key can't refresh;
