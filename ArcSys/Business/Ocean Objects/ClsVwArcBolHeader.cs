...
namespace CS2010.ArcSys.Business
{
	public partial class ClsVwArcBolHeader : ClsBaseTable
	{
		...
		public const int Finalmanifest_DtMax = 27;
		public const int Portpairclosed_DtMax = 27;
		...
		protected Int32? _Pol_Call_ID;
		protected Int32? _Pod_Call_ID;
		protected DateTime? _Finalmanifest_Dt;
		protected DateTime? _Portpairclosed_Dt;
		...
		public Int32? Pol_Call_ID
		{
			get { return _Pol_Call_ID; }
			set
			{
				if( _Pol_Call_ID == value ) return;
		
				_Pol_Call_ID = value;
				_IsDirty = true;
				NotifyPropertyChanged("Pol_Call_ID");
			}
		}
		public Int32? Pod_Call_ID
		{
			get { return _Pod_Call_ID; }
			set
			{
				if( _Pod_Call_ID == value ) return;
		
				_Pod_Call_ID = value;
				_IsDirty = true;
				NotifyPropertyChanged("Pod_Call_ID");
			}
		}
		public DateTime? Finalmanifest_Dt
		{
			get { return _Finalmanifest_Dt; }
			set
			{
    			_Finalmanifest_Dt = value;
		
				_IsDirty = true;
				NotifyPropertyChanged("Finalmanifest_Dt");
			}
		}
		public DateTime? Portpairclosed_Dt
		{
			get { return _Portpairclosed_Dt; }
			set
			{
					_Portpairclosed_Dt = value;
		
				_IsDirty = true;
				NotifyPropertyChanged("Portpairclosed_Dt");
			}
		}
		...
		public override void ResetColumns()
		{
			...
			Pol_Call_ID = null;
			Pod_Call_ID = null;
			Finalmanifest_Dt = null;
			Portpairclosed_Dt = null;
		}
		...
		public void CopyFrom(ClsVwArcBolHeader src)
		{
			...
			Pol_Call_ID = src._Pol_Call_ID;
			Pod_Call_ID = src._Pod_Call_ID;
			Finalmanifest_Dt = src._Finalmanifest_Dt;
			Portpairclosed_Dt = src._Portpairclosed_Dt;
		}
		...
		public override int Insert()
		{
			...
			DbParameter[] p = new DbParameter[44];
			...
			p[40] = Connection.GetParameter
				("@pol_call_id", Pol_Call_ID);
			p[41] = Connection.GetParameter
				("@pod_call_id", Pod_Call_ID);
			p[42] = Connection.GetParameter
				("@FinalManifest_dt", Finalmanifest_Dt);
			p[43] = Connection.GetParameter
				("@PortPairClosed_Dt", Portpairclosed_Dt);
			...
			const string sql = @"INSERT INTO vw_arc_bol_header VALUES
				...
				,@CustomsReleaseCodeId,@ItnNumber,@liner_release_cd
				,@customs_release_cd,@pol_call_id,@pod_call_id
				,@FinalManifest_dt,@PortPairClosed_Dt)";
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Pol_Call_ID = ClsConvert.ToInt32Nullable(dr["pol_call_id"]);
			Pod_Call_ID = ClsConvert.ToInt32Nullable(dr["pod_call_id"]);
			Finalmanifest_Dt = ClsConvert.ToDateTimeNullable(dr["FinalManifest_dt"]);
			Portpairclosed_Dt = ClsConvert.ToDateTimeNullable(dr["PortPairClosed_Dt"]);
		}
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Pol_Call_ID = ClsConvert.ToInt32Nullable(dr["pol_call_id", v]);
			Pod_Call_ID = ClsConvert.ToInt32Nullable(dr["pod_call_id", v]);
			Finalmanifest_Dt = ClsConvert.ToDateTimeNullable(dr["FinalManifest_dt", v]);
			Portpairclosed_Dt = ClsConvert.ToDateTimeNullable(dr["PortPairClosed_Dt", v]);
		}
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["pol_call_id"] = ClsConvert.ToDbObject(Pol_Call_ID);
			dr["pod_call_id"] = ClsConvert.ToDbObject(Pod_Call_ID);
			dr["FinalManifest_dt"] = ClsConvert.ToDbObject(Finalmanifest_Dt);
			dr["PortPairClosed_Dt"] = ClsConvert.ToDbObject(Portpairclosed_Dt);
		}
