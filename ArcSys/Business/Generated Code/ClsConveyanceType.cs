...
{
	public partial class ClsConveyanceType : ClsBaseTable
	{
		...
		public const string TableName = "R_CONVEYANCE_TYPE";
		...
		{
			return new string[PrimaryKeyCount] { "CONVEYANCE_TYPE_CD" };
		}

		public const string SelectSQL = "SELECT * FROM R_CONVEYANCE_TYPE";
		...
		public const int Conveyance_Type_DscMax = 50;
		...
		protected string _Conveyance_Type_Dsc;
		...
		public string Conveyance_Type_Dsc
		{
			get { return _Conveyance_Type_Dsc; }
			set
			{
				string val = ( string.IsNullOrEmpty(value) == false )
					? value.Trim() : null;
				...
				if( string.Compare(_Conveyance_Type_Dsc, val, false) == 0 ) return;
		
				if( val != null && val.Length > Conveyance_Type_DscMax )
					_Conveyance_Type_Dsc = val.Substring(0, (int)Conveyance_Type_DscMax);
				else
					_Conveyance_Type_Dsc = val;
		
				_IsDirty = true;
				NotifyPropertyChanged("Conveyance_Type_Dsc");
			}
		}
		...
		public ClsConveyanceType() : base() {}
		public ClsConveyanceType(DataRow dr) : base(dr) {}
		public ClsConveyanceType(ClsConveyanceType src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsConveyanceType src)
		{
			Conveyance_Type_Cd = src._Conveyance_Type_Cd;
			Conveyance_Type_Dsc = src._Conveyance_Type_Dsc;
		...
		{
			ClsConveyanceType tmp = ClsConveyanceType.GetUsingKey(Conveyance_Type_Cd);
		...
		public override int Insert()
		{
			...
			p[1] = Connection.GetParameter
				("@CONVEYANCE_TYPE_DSC", Conveyance_Type_Dsc);
			...
			const string sql = @"
				INSERT INTO R_CONVEYANCE_TYPE
					(CONVEYANCE_TYPE_CD, CONVEYANCE_TYPE_DSC, ACTIVE_FLG)
				VALUES
					(@CONVEYANCE_TYPE_CD, @CONVEYANCE_TYPE_DSC, @ACTIVE_FLG)
				RETURNING
		...
		public override int Delete()
		{
			...
			const string sql = @"
				DELETE FROM R_CONVEYANCE_TYPE WHERE
				CONVEYANCE_TYPE_CD=@CONVEYANCE_TYPE_CD";
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Conveyance_Type_Dsc = ClsConvert.ToString(dr["CONVEYANCE_TYPE_DSC"]);
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Conveyance_Type_Dsc = ClsConvert.ToString(dr["CONVEYANCE_TYPE_DSC", v]);
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["CONVEYANCE_TYPE_DSC"] = ClsConvert.ToDbObject(Conveyance_Type_Dsc);
		...
		public static ClsConveyanceType GetUsingKey(string Conveyance_Type_Cd)
		{
			object[] vals = new object[] {Conveyance_Type_Cd};
			DataRow dr = Connection.GetDataRowUsingKey
				(TableName, GetPrimaryKeys(), vals);
			return ( dr == null ) ? null : new ClsConveyanceType(dr);
		}
