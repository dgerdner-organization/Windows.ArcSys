...
{
	public partial class ClsUscOceanBb : ClsBaseTable
	{
		...
		public const string TableName = "T_USC_OCEAN_BB";
		...
		{
			return new string[PrimaryKeyCount] { "USC_OCEAN_BB_ID" };
		}

		public const string SelectSQL = @"SELECT * FROM T_USC_OCEAN_BB 
				LEFT OUTER JOIN T_CONTRACT_MOD
				ON T_USC_OCEAN_BB.CONTRACT_MOD_ID=T_CONTRACT_MOD.CONTRACT_MOD_ID ";
		...
		protected Int64? _Usc_Ocean_Bb_ID;
		...
		public Int64? Usc_Ocean_Bb_ID
		{
			get { return _Usc_Ocean_Bb_ID; }
			set
			{
				if( _Usc_Ocean_Bb_ID == value ) return;
		
				_Usc_Ocean_Bb_ID = value;
				_IsDirty = true;
				NotifyPropertyChanged("Usc_Ocean_Bb_ID");
			}
		}
		...
		public ClsUscOceanBb() : base() {}
		public ClsUscOceanBb(DataRow dr) : base(dr) {}
		public ClsUscOceanBb(ClsUscOceanBb src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsUscOceanBb src)
		{
			Usc_Ocean_Bb_ID = src._Usc_Ocean_Bb_ID;
		...
		{
			ClsUscOceanBb tmp = ClsUscOceanBb.GetUsingKey(Usc_Ocean_Bb_ID.Value);
		...
		public override int Insert()
		{
			...
			p[19] = Connection.GetParameter
				("@USC_OCEAN_BB_ID", Usc_Ocean_Bb_ID, ParameterDirection.Output, DbType.Int64, 0);
			...
			const string sql = @"
				INSERT INTO T_USC_OCEAN_BB
					(USC_OCEAN_BB_ID, ACTIVE_FLG, OTO_FLG,
				...
				VALUES
					(USC_OCEAN_BB_ID_SEQ.NEXTVAL, @ACTIVE_FLG, @OTO_FLG,
					@RFP, @OCEAN_TYPE, @SERVICE,
					@ROUTE, @DIRECTION, @ORIGIN,
					@DESTINATION, @COMMODITY, @CONTAINER_TYPE,
					@CONTAINER_SIZE, @CARRIER_CD, @RATE_AMT,
					...
					@EXPIRE_DT, @CONTRACT_MOD_ID)
				RETURNING
					USC_OCEAN_BB_ID, CREATE_USER, CREATE_DT,
			...
			Usc_Ocean_Bb_ID = ClsConvert.ToInt64Nullable(p[19].Value);
		...
		public override int Update()
		{
			...
			p[19] = Connection.GetParameter
				("@CONTRACT_MOD_ID", Contract_Mod_ID);
			p[20] = Connection.GetParameter
				("@USC_OCEAN_BB_ID", Usc_Ocean_Bb_ID);
			p[21] = Connection.GetParameter
				("@MODIFY_USER", Modify_User, ParameterDirection.Output, DbType.AnsiStringFixedLength, Modify_UserMax);

			const string sql = @"
				UPDATE T_USC_OCEAN_BB SET
					MODIFY_DT = @MODIFY_DT,
					ACTIVE_FLG = @ACTIVE_FLG,
					OTO_FLG = @OTO_FLG,
					RFP = @RFP,
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Usc_Ocean_Bb_ID = ClsConvert.ToInt64Nullable(dr["USC_OCEAN_BB_ID"]);
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Usc_Ocean_Bb_ID = ClsConvert.ToInt64Nullable(dr["USC_OCEAN_BB_ID", v]);
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["USC_OCEAN_BB_ID"] = ClsConvert.ToDbObject(Usc_Ocean_Bb_ID);
		...
		public static ClsUscOceanBb GetUsingKey(Int64 Usc_Ocean_Bb_ID)
		{
			object[] vals = new object[] {Usc_Ocean_Bb_ID};
			DataRow dr = Connection.GetDataRowUsingKey
				(TableName, GetPrimaryKeys(), vals);
			return ( dr == null ) ? null : new ClsUscOceanBb(dr);
		}
		public static DataTable GetAll(Int64? Contract_Mod_ID)
		{
			...
			if( Contract_Mod_ID != null && Contract_Mod_ID > 0 )
			{
				...
				sb.Append(" WHERE T_USC_OCEAN_BB.CONTRACT_MOD_ID=@CONTRACT_MOD_ID");
			}
