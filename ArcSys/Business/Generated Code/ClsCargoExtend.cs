...
{
	public partial class ClsCargoExtend : ClsBaseTable
	{
		...
		public const string TableName = "T_CARGO_EXTEND";
		...
		public const string SelectSQL = "SELECT * FROM T_CARGO_EXTEND";
		...
		protected decimal? _Original_Weight_Nbr;
		...
		public decimal? Original_Weight_Nbr
		{
			get { return _Original_Weight_Nbr; }
			set
			{
				if( _Original_Weight_Nbr == value ) return;
		
				_Original_Weight_Nbr = value;
				_IsDirty = true;
				NotifyPropertyChanged("Original_Weight_Nbr");
			}
		}
		...
		public ClsCargoExtend() : base() {}
		public ClsCargoExtend(DataRow dr) : base(dr) {}
		public ClsCargoExtend(ClsCargoExtend src) { CopyFrom(src); }
		...
		public override void ResetColumns()
		{
			...
			Booking_No = null;
			Dim_Vgm_Nbr = null;
			Original_Weight_Nbr = null;
		}

		public void CopyFrom(ClsCargoExtend src)
		{
			...
			Original_Weight_Nbr = src._Original_Weight_Nbr;
		}

		public override bool ReloadFromDB()
		{
			ClsCargoExtend tmp = ClsCargoExtend.GetUsingKey(Cargo_Key);
		...
		public override int Insert()
		{
			...
			p[3] = Connection.GetParameter
				("@ORIGINAL_WEIGHT_NBR", Original_Weight_Nbr);
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Original_Weight_Nbr = ClsConvert.ToDecimalNullable(dr["ORIGINAL_WEIGHT_NBR"]);
		}
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Original_Weight_Nbr = ClsConvert.ToDecimalNullable(dr["ORIGINAL_WEIGHT_NBR", v]);
		}
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["ORIGINAL_WEIGHT_NBR"] = ClsConvert.ToDbObject(Original_Weight_Nbr);
		}
		...
		public static ClsCargoExtend GetUsingKey(string Cargo_Key)
		{
			object[] vals = new object[] {Cargo_Key};
			DataRow dr = Connection.GetDataRowUsingKey
				(TableName, GetPrimaryKeys(), vals);
			return ( dr == null ) ? null : new ClsCargoExtend(dr);
		}
