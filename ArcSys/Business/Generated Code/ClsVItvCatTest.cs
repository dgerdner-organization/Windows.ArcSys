...
{
	public partial class ClsVItvCatTest : ClsBaseTable
	{
		...
		public const string TableName = "V_ITV_CAT_TEST";
		...
		public const string SelectSQL = "SELECT * FROM V_ITV_CAT_TEST";
		...
		public ClsVItvCatTest() : base() {}
		public ClsVItvCatTest(DataRow dr) : base(dr) {}
		public ClsVItvCatTest(ClsVItvCatTest src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsVItvCatTest src)
		{
		...
		{
			ClsVItvCatTest tmp = null;	//No primary key can't refresh;
