...
{
	public partial class ClsTerminalSection : ClsBaseTable
	{
		...
		public const string TableName = "R_TERMINAL_SECTION";
		...
		{
			return new string[PrimaryKeyCount] { "TERMINAL_SECTION_CD" };
		}

		public const string SelectSQL = "SELECT * FROM R_TERMINAL_SECTION";
		...
		public const int Terminal_Section_DscMax = 50;
		...
		protected string _Terminal_Section_Dsc;
		...
		public string Terminal_Section_Dsc
		{
			get { return _Terminal_Section_Dsc; }
			set
			{
				string val = ( string.IsNullOrEmpty(value) == false )
					? value.Trim() : null;
				...
				if( string.Compare(_Terminal_Section_Dsc, val, false) == 0 ) return;
		
				if( val != null && val.Length > Terminal_Section_DscMax )
					_Terminal_Section_Dsc = val.Substring(0, (int)Terminal_Section_DscMax);
				else
					_Terminal_Section_Dsc = val;
		
				_IsDirty = true;
				NotifyPropertyChanged("Terminal_Section_Dsc");
			}
		}
		...
		public ClsTerminalSection() : base() {}
		public ClsTerminalSection(DataRow dr) : base(dr) {}
		public ClsTerminalSection(ClsTerminalSection src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsTerminalSection src)
		{
			Terminal_Section_Cd = src._Terminal_Section_Cd;
			Terminal_Section_Dsc = src._Terminal_Section_Dsc;
		...
		{
			ClsTerminalSection tmp = ClsTerminalSection.GetUsingKey(Terminal_Section_Cd);
		...
		public override int Insert()
		{
			...
			p[1] = Connection.GetParameter
				("@TERMINAL_SECTION_DSC", Terminal_Section_Dsc);
			...
			const string sql = @"
				INSERT INTO R_TERMINAL_SECTION
					(TERMINAL_SECTION_CD, TERMINAL_SECTION_DSC, ACTIVE_FLG)
				VALUES
					(@TERMINAL_SECTION_CD, @TERMINAL_SECTION_DSC, @ACTIVE_FLG)
				RETURNING
		...
		public override int Delete()
		{
			...
			const string sql = @"
				DELETE FROM R_TERMINAL_SECTION WHERE
				TERMINAL_SECTION_CD=@TERMINAL_SECTION_CD";
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Terminal_Section_Dsc = ClsConvert.ToString(dr["TERMINAL_SECTION_DSC"]);
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Terminal_Section_Dsc = ClsConvert.ToString(dr["TERMINAL_SECTION_DSC", v]);
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["TERMINAL_SECTION_DSC"] = ClsConvert.ToDbObject(Terminal_Section_Dsc);
		...
		public static ClsTerminalSection GetUsingKey(string Terminal_Section_Cd)
		{
			object[] vals = new object[] {Terminal_Section_Cd};
			DataRow dr = Connection.GetDataRowUsingKey
				(TableName, GetPrimaryKeys(), vals);
			return ( dr == null ) ? null : new ClsTerminalSection(dr);
		}
