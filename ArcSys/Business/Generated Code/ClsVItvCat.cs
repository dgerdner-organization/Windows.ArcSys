...
{
	public partial class ClsVItvCat : ClsBaseTable
	{
		...
		public const string TableName = "V_ITV_CAT";
		...
		public const string SelectSQL = "SELECT * FROM V_ITV_CAT";
		...
		public ClsVItvCat() : base() {}
		public ClsVItvCat(DataRow dr) : base(dr) {}
		public ClsVItvCat(ClsVItvCat src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsVItvCat src)
		{
		...
		{
			ClsVItvCat tmp = null;	//No primary key can't refresh;
