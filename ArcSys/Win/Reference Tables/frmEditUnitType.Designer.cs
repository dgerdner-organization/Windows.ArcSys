namespace CS2010.ArcSys.Win
{
	partial class frmEditUnitType
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmEditUnitType));
			...
			this.txtDbColumNm = new CS2010.CommonWinCtrls.ucTextBox();
			this.txtGridDesc = new CS2010.CommonWinCtrls.ucTextBox();
			this.chkUnitsRequired = new CS2010.CommonWinCtrls.ucCheckBox();
			...
			// txtCode
			// 
			this.txtCode.LabelText = "&Unit Type Code";
			...
			this.grdResults.Size = new System.Drawing.Size(782, 388);
			...
			// pnlMain.Panel2
			// 
			this.pnlMain.Panel2.Controls.Add(this.txtDbColumNm);
			this.pnlMain.Panel2.Controls.Add(this.txtGridDesc);
			this.pnlMain.Panel2.Controls.Add(this.chkUnitsRequired);
			...
			this.pnlMain.SplitterDistance = 388;
			this.pnlMain.TabIndex = 1;
			// 
			// txtDbColumNm
			// 
			this.txtDbColumNm.LabelText = "DB Column Name";
			this.txtDbColumNm.LabelType = CS2010.CommonWinCtrls.TextLabelType.Label;
			this.txtDbColumNm.LinkDisabledMessage = "Link Disabled";
			this.txtDbColumNm.Location = new System.Drawing.Point(100, 90);
			this.txtDbColumNm.Name = "txtDbColumNm";
			this.txtDbColumNm.Size = new System.Drawing.Size(181, 20);
			this.txtDbColumNm.TabIndex = 7;
			// 
			// txtGridDesc
			// 
			this.txtGridDesc.CharacterCasing = System.Windows.Forms.CharacterCasing.Normal;
			this.txtGridDesc.LabelText = "Grid Description";
			this.txtGridDesc.LabelType = CS2010.CommonWinCtrls.TextLabelType.Label;
			this.txtGridDesc.LinkDisabledMessage = "Link Disabled";
			this.txtGridDesc.Location = new System.Drawing.Point(100, 64);
			this.txtGridDesc.Name = "txtGridDesc";
			this.txtGridDesc.Size = new System.Drawing.Size(317, 20);
			this.txtGridDesc.TabIndex = 5;
			// 
			// chkUnitsRequired
			// 
			this.chkUnitsRequired.AutoSize = true;
			this.chkUnitsRequired.Location = new System.Drawing.Point(185, 116);
			this.chkUnitsRequired.Name = "chkUnitsRequired";
			this.chkUnitsRequired.Size = new System.Drawing.Size(96, 17);
			this.chkUnitsRequired.TabIndex = 9;
			this.chkUnitsRequired.Text = "Units Required";
			this.chkUnitsRequired.UseVisualStyleBackColor = true;
			this.chkUnitsRequired.YN = "N";
			// 
			// chkActive
			// 
			this.chkActive.AutoSize = true;
			this.chkActive.Location = new System.Drawing.Point(100, 116);
			...
			this.Name = "frmEditUnitType";
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "Unit Type Maintenance";
		...
		private CommonWinCtrls.ucTextBox txtGridDesc;
		private CommonWinCtrls.ucCheckBox chkUnitsRequired;
		private CommonWinCtrls.ucTextBox txtDbColumNm;
	}
}