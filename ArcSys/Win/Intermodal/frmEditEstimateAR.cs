...
{
	public partial class frmEditEstimateAR : frmChildBase
	{	//TODO: JROMAN
		...
		private static frmEditEstimateAR EditWindow;
		...
		public static frmEditEstimateAR AddCharge(ClsEstimate anEstimate, string finCd,
			ChargeCategory cat, ClsEstimateCharge copyChg)
		{
			try
			{
				...
				if (EditWindow == null)
				{
					...
					EditWindow = new frmEditEstimateAR();
		...
		public static frmEditEstimateAR EditCharge(ClsEstimateCharge aCharge)
		{
			try
			{
		...
		private void frmEditEstimateAR_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private void frmEditEstimateAR_FormClosing(object sender, FormClosingEventArgs e)
		{
			try
			{
		...
		private void frmEditEstimateAR_FormClosed(object sender, FormClosedEventArgs e)
		{
			EditWindow = null;
		}
		...
		private void frmEditEstimateAR_KeyDown(object sender, KeyEventArgs e)
		{
			try
			{
