...
{
	public partial class frmSearchEstimateOptions : frmDialogBase
	{
		...
		public frmSearchEstimateOptions()
		{
			InitializeComponent();
		...
		private void txtEstimateID_KeyPress(object sender, KeyPressEventArgs e)
		{
			try
			{
		...
		protected override bool SaveChanges()
		{
			try
			{
				...
				_Options.csvEstimateID = txtEstimateID.Text.Trim();

				_Options.Vessel_Sail_Dt = grpSailDt.CheckedValueRange;

                _Options.RegionAll = rbRegionAll.Checked;
                _Options.RegionConus = rbRegionConus.Checked;
                _Options.RegionOConus = rbRegionOconus.Checked;
