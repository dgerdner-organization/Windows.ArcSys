...
{
	public partial class ClsCategory : ClsBaseTable
	{
		...
		public const string TableName = "R_CATEGORY";
		...
		{
			return new string[PrimaryKeyCount] { "CATEGORY_CD" };
		}

		public const string SelectSQL = "SELECT * FROM R_CATEGORY";
		...
		public const int Category_NmMax = 50;
		...
		public string Category_Nm
		{
			...
			set
			{
				...
				if( string.Compare(_Category_Nm, val, false) == 0 ) return;
		
				if( val != null && val.Length > Category_NmMax )
					_Category_Nm = val.Substring(0, (int)Category_NmMax);
				else
					_Category_Nm = val;
		
				_IsDirty = true;
				NotifyPropertyChanged("Category_Nm");
			}
		}
		...
		public ClsCategory() : base() {}
		public ClsCategory(DataRow dr) : base(dr) {}
		public ClsCategory(ClsCategory src) { CopyFrom(src); }
		...
		public void CopyFrom(ClsCategory src)
		{
			...
			Category_Nm = src._Category_Nm;
		}

		public override bool ReloadFromDB()
		{
			ClsCategory tmp = ClsCategory.GetUsingKey(Category_Cd);
		...
		public override int Insert()
		{
			...
			const string sql = @"
				INSERT INTO R_CATEGORY
					(CATEGORY_CD, ACTIVE_FLG, CATEGORY_NM)
				VALUES
					(@CATEGORY_CD, @ACTIVE_FLG, @CATEGORY_NM)
				RETURNING
		...
		public override void LoadFromDataReader(DbDataReader dr)
		{
			...
			Category_Nm = ClsConvert.ToString(dr["CATEGORY_NM"]);
		}
		...
		public override void LoadFromDataRow(DataRow dr)
		{
			...
			Category_Nm = ClsConvert.ToString(dr["CATEGORY_NM", v]);
		}
		...
		public override void CopyToDataRow(DataRow dr)
		{
			...
			dr["CATEGORY_NM"] = ClsConvert.ToDbObject(Category_Nm);
		}
		...
		public static ClsCategory GetUsingKey(string Category_Cd)
		{
			object[] vals = new object[] {Category_Cd};
