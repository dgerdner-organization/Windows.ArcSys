...
{
	public partial class frmSearchIssues : frmChildBase
	{
		#region Constants
		...
		private frmSearchIssuesOptions SearchOptions;
		...
		public frmSearchIssues() : base(true)
		{
			InitializeComponent();

			SearchOptions = new frmSearchIssuesOptions();
		...
		private void ActionsMenuInit()
		{
			try
			{
				...
				cnuActionsPriority.Tag = "PRIORITY";
		...
		/// one frmSearchIssues window is visible at any given time</summary>
		private static frmSearchIssues SearchWindow;

		/// <summary>Main entry point into this window ensuring that no more than 1
		/// frmSearchIssues window is visible at any given time</summary>
		public static frmSearchIssues Search(bool showOptions, bool performDefaultSearch)
		{
			try
			{
				if( SearchWindow == null ) SearchWindow = new frmSearchIssues();
				...
				if( showOptions )
					...
					SearchWindow.PerformDefaultSearch();
		...
		private void ShowActionMenu()
		{
			try
			{
				...
				cnuActionsStatusApprove.Visible = cnuActionsStatusClose.Visible =
				...
				cnuActionsStatusApprove.Enabled = cnuActionsStatusClose.Enabled =
				...
				cnuActionsPriority.Enabled = false;
				cnuActionsEditIssue.Enabled = true;

				if( issue.IsNew )
				{
					//cnuActionsStatusNoAction.Visible = cnuActionsAddNote.Visible = true;
					cnuActionsAddNote.Visible = cnuActionsPriority.Enabled = true;

					cnuActionsStatusDev.Visible = cnuActionsStatusHold.Visible =
						cnuActionsStatusSpec.Visible = cnuActionsStatusClose.Visible = true;

					cnuActionsStatusDev.Enabled = cnuActionsStatusHold.Enabled =
						cnuActionsStatusSpec.Enabled = cnuActionsStatusClose.Enabled =
				...
				else if( issue.IsHold )
				{
					...
					cnuActionsStatusDev.Visible = cnuActionsStatusSpec.Visible =
						cnuActionsStatusClose.Visible = true;

					cnuActionsStatusDev.Enabled = cnuActionsStatusSpec.Enabled =
						cnuActionsStatusClose.Enabled = ClsEnvironment.IsDeveloper;
				...
				else if( issue.IsDev )
				{
					...
					cnuActionsStatusPend.Visible = cnuActionsStatusSpec.Visible =
						cnuActionsStatusTest.Visible = cnuActionsStatusHold.Visible =
						cnuActionsStatusClose.Visible = true;
				...
				{
					cnuActionsPriority.Enabled = true;
				...
				{
					cnuActionsStatusDev.Visible = cnuActionsStatusClose.Visible =
				...
				{
					cnuActionsStatusDev.Visible = cnuActionsStatusApprove.Visible =
						cnuActionsStatusClose.Visible = true;
					cnuActionsStatusDev.Text = "Testing Failed/Need Assistance - Set status to DEV";
		...
		private void cnuOptionsCreate_Click(object sender, EventArgs e)
		{
			try
			{
				...
				using( frmCreateIssue f = new frmCreateIssue() )
				{
					newIssue = f.CreateIssue();
				}
		...
		private void AddNote()
		{
			try
			{
				...
				DataTable dt = dtNotes;
				if( dt != null )
				{
					DataRow drNew = dt.NewRow();
					nt.CopyToDataRow(drNew);
					dt.Rows.Add(drNew);
				}
		...
		private void frmSearchIssues_FormClosing(object sender, FormClosingEventArgs e)
		{
			try
			{
		...
		private void frmSearchIssues_FormClosed(object sender, FormClosedEventArgs e)
		{
			SearchWindow = null;
