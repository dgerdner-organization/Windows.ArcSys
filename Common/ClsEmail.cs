	...
	public class ClsEmail : INotifyPropertyChanged
	{
		...
		public void SendMail(bool blnHTML)
		{
			...
			try
			{
                ...
                client.Port = 2525;
                client.Credentials = new System.Net.NetworkCredential("arcsys-notifications@arcshipping.com", "Liberty@8800!");
                mMsg.From = new MailAddress("arcsys-notifications@arcshipping.com");
